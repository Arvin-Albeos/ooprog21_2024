...
public class SammysRentalPrice {
   ...
   public static void main(String[] args) {
      ...
      //This is so that the first hour, regardless if it is less than or exactly one hour, the price would remain $40.
      //Only with the following hours after the first, would the additional $1 per minute will be added.                    
      if(mins < 60){
